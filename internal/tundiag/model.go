...
const (
	...
	ClassTunAddressConflict          Classification = "tun_address_conflict"
	ClassTunAddressApplyFailure      Classification = "tun_address_apply_failure"
	ClassTunAddressVerifyFailure     Classification = "tun_address_verify_failure"
	ClassDNSApplyFailure             Classification = "dns_apply_failure"
	ClassForeignDNSConflict          Classification = "foreign_dns_conflict"
	ClassResolvedLinkNotReady        Classification = "resolved_link_not_ready"
	ClassResolvedLinkQueryFailure    Classification = "resolved_link_query_failure"
	ClassSystemResolverFailure       Classification = "system_resolver_failure"
