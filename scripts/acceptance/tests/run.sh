...
bash "$SCRIPT_DIR/standalone_failure_evidence_truth.sh"
bash "$SCRIPT_DIR/failure_evidence_applicability_contract.sh"
bash "$SCRIPT_DIR/failure_evidence_replay_boundary_contract.sh"
bash "$SCRIPT_DIR/failure_evidence_validation_contract.sh"
